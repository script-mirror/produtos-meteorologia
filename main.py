...
download_sfc_params = {
    ...
    } # Não precisa, mas n pode ficar vazio
...
def map_produtos(produtos=None, tipo='forecast'):
    ...
    if tipo == 'forecast':
        ...
        return {
            ...
            "prob_clim_cfsv2_12rod": lambda: produtos.gerar_probabilidade_climatologia(extent=CONSTANTES['extents_mapa']['brasil'], add_valor_bacias=True, periods_cfs=12, ensemble=False),
            ...
            "chuva_geop500_v850": lambda: produtos.gerar_chuva_geop500_vento850(),
            ...
            "sst_cfsv2_12rod": lambda: produtos.gerar_ocnsst_cfsv2(periods_cfs=12, resample_freq='sop', anomalia_sop=True, extent=CONSTANTES['extents_mapa']['global']),
            "sst_cfsv2_28rod": lambda: produtos.gerar_ocnsst_cfsv2(periods_cfs=28, resample_freq='sop', anomalia_sop=True, extent=CONSTANTES['extents_mapa']['global']),
            "psi_cfsv2_12rod": lambda: produtos.gerar_psi_cfsv2(periods_cfs=12, resample_freq='sop', anomalia_sop=True, extent=CONSTANTES['extents_mapa']['global']),
            "psi_cfsv2_28rod": lambda: produtos.gerar_psi_cfsv2(periods_cfs=28, resample_freq='sop', anomalia_sop=True, extent=CONSTANTES['extents_mapa']['global']),
        ...
        return {
            ...
            "estacao_chuvosa": lambda: produtos.gerar_estacao_chuvosa(),
...
def main():
    ...
    if outros_vazios:
        ...
        DIA_ATUAL_FMT = DIA_ATUAL.strftime(f'%Y-%m-%d') if args.modelo_fmt not in ['nmme', 'c3s', 'ecmwf-mensal'] else DIA_ATUAL.strftime(f'%Y-%m-01')
        HORA = DIA_ATUAL.hour        
        ...
        if args.modelo_fmt in ['gfs', 'gefs', 'gefs-wind', 'gefs-estendido-wind', 'gefs-membros', 'gefs-membros-estendido', 'gefs-estendido', 'pconjunto-ons', 'gefs-membros-estendido', 'cfsv2', 'cfsv2-mensal', 'cmc-ens', 'gefs-bc', 'aigfs', 'aigefs', 'hgefs', 'nmme', 'c3s', 'ecmwf-mensal']:
            args.resolucao = '0p50'
        ...
        elif args.modelo_fmt in ['gefs-membros', 'gefs-membros-estendido', 'ecmwf-ens-membros', 'ecmwf-aifs-ens-membros', 'ecmwf-ens-estendido', 'ecmwf-ens-estendido-membros', 'pconjunto-ons', 'eta', 'gefs-wind', 'gefs-estendido-wind', 'cfsv2', 'cfsv2-mensal', 'cmc-ens', 'gefs-bc', 'aigfs', 'aigefs', 'hgefs', 'nmme', 'c3s', 'ecmwf-mensal']:
            args.sfc_prefix = 'sfc'
            args.pl_prefix = None
    ...
    if args.modelo_fmt not in modelos_observados:
        ...
        # Remove arquivos
        if args.modelo_fmt not in ['cfsv2', 'cfsv2-mensal', 'nmme', 'c3s', 'ecmwf']:
